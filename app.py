...
LozanoLsa · Project 03 · K-Nearest Neighbors · 2021 
"""
...
with st.sidebar:
    ...
    st.caption("Where f(x) meets Kaizen · 2023")
...
<div class="lsa-header">
    ...
    <div class="lsa-title">Motor Failures Prediction</div>
...
<div class="lsa-footer">
    LozanoLsa · Turning Operations into Predictive Systems · KNN Motor Failure Predictor · Project 03 · v6.0
</div>
""", unsafe_allow_html=True)
